...
class sibiKataTanya extends StatelessWidget {
  @override
    ...
    return Scaffold(
        ...
        body: SafeArea(
          ...
          child: Column(children: [
            Expanded(
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Image.asset(
                        'assets/images/kata-tanya.png',
                        width: 75,
                        height: 75,
                      ),
                      const Text('KATA TANYA SIBI',
                          style: TextStyle(
            ...
            Expanded(flex: 10, child: listSibiKataTanya()),
            Footer(
              backgroundColor: const Color.fromRGBO(222, 252, 249, 1),
...
class listSibiKataTanya extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: StreamBuilder<QuerySnapshot>(
        stream:
            _firebaseFirestore.collection('kataTanya').orderBy('k').snapshots(),
